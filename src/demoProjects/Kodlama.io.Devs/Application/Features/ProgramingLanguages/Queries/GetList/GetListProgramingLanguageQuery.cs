...
namespace Application.Features.ProgramingLanguages.Queries.GetList
{
    public class GetListProgramingLanguageQuery : IRequest<ProgramingLanguageListModel>
    {
        ...
        public class GetListProgramingLanguageQueryHandler : IRequestHandler<GetListProgramingLanguageQuery,
                                                                           ProgramingLanguageListModel>
        {
            ...
            {
                IPaginate<ProgramingLanguage> progLanguages =
                    await _programingLanguageRepository
                    .GetListAsync(index: request.PageRequest.Page,
                                  size: request.PageRequest.PageSize);

                ProgramingLanguageListModel mappedProgLanguageListModel = _mapper.Map
                                                                            <ProgramingLanguageListModel>
                                                                            (progLanguages);
