    ...
    public class DeleteTechnologyCommand : IRequest<DeletedTechnologyDto>
    {
                                                                      ...
                                                                      DeletedTechnologyDto>
        {
            ...
            public async Task<DeletedTechnologyDto> Handle(DeleteTechnologyCommand request, CancellationToken cancellationToken)
            {
                ...
                await _technologyBusinessRules.TechnologyExists(technology);

                technology = await _technologyRepository.DeleteAsync(technology);
                DeletedTechnologyDto mappedDeletedDto = _mapper.Map<DeletedTechnologyDto>(technology);
                return mappedDeletedDto;
            }
        }
